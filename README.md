...
The final report includes a placeholder GitHub repository URL. Before submitting, upload this folder to your GitHub account and replace the placeholder URL in `report/final_report.tex` with your real repository link.
